...
and unsettled turns surface as hard failures. The evidence trail becomes
auditable from git through committed per-harness summaries, and promotion of
any adaptive record becomes a measured 3-consecutive-clean-run event.
