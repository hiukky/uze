...
Inside the TUI, the **Settings** route holds both lists; `t` still opens the
...
[`crates/uze-theme/themes/theme.schema.json`](https://github.com/uze-sh/uze/blob/main/crates/uze-theme/themes/theme.schema.json)
for completion over every token and symbol name.

<Cards>
  <Card title="Shortcuts" href="/docs/configuration/keys" />
