...
delivers them to each harness — [Claude Code](https://code.claude.com),
[Codex](https://chatgpt.com/codex), [OpenCode](https://opencode.ai),
[Antigravity](https://antigravity.google) — through the most native mechanism
