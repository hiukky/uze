...
<Callout type="info">
  A local marketplace is still a **Git repository**, and installing clones it at a commit rather
...
`marketplace.json` was briefly named `agents.json` and reverted (ADR-032) — the same manifest
