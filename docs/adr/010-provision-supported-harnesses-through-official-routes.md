...
- Claude Code documents native installers for Unix and PowerShell/CMD on
  Windows, plus `claude update`. [Installation](https://code.claude.com/docs/en/installation)
- Codex documents first-party Unix/Windows installers and `codex update`.
  [README](https://github.com/openai/codex/blob/main/README.md)
- OpenCode documents its Unix installer and `opencode upgrade`; its Windows
